...
This repository contains a Java-based extension for Burp Suite using the burp.api.montoya API. The extension is designed to solve a specific lab involving blind XXE with out-of-band interaction.
...
jar cvf 'Lab: Blind XXE with out-of-band interaction.jar' -C build/ .
```
...
4. Select the JAR file `Lab: Blind XXE with out-of-band interaction.jar`.
