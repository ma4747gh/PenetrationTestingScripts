...
class LabSolver:
    ...
    def register_new_account(self):
        ...
        data = {
            ...
            'username': 'hacker',
            'email': 'hacker@' + self.email_client.split('/')[2],
    ...
    def sign_in_as_administrator_and_change_email_and_delete_carlos(self):
        data = {
        ...
        self.session.post(self.lab_url + 'my-account/change-email', data=data)
    ...
    def solve(self):
        ...
        self.sign_in_as_administrator_and_change_email_and_delete_carlos()
